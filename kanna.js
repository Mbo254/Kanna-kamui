...
module.exports = async (kanna, m, commands, chatUpdate) => {
    try {
        ...
        let metadata = isGroup ? await kanna.groupMetadata(from) : {}
        ...
        let isBotAdmin = isGroup ? groupAdmin.includes(kanna.user?.jid) : false
        let isAdmin = isGroup ? groupAdmin.includes(sender) : false
        let isOwner = [kanna.user?.jid, ...config.owner].map(v => v.replace(/[^0-9]/g, '') + '@s.whatsapp.net').includes(sender)
        ...
        user.expiredCheck(kanna, m, _user);

        if (config.options.autoRead) (kanna.type == "legacy") ? await kanna.chatRead(m.key, 1) : await kanna.sendReadReceipt(from, sender, [m.id])
        ...
        if (isMedia && m.msg.fileSha256 && (m.msg.fileSha256.toString("hex") in global.db.sticker)) {
            ...
            let messages = await generateWAMessage(m.from, { text, mentions }, {
                userJid: kanna.user.jid,
                quoted: m.quoted && m.quoted.fakeObj
            })
            messages.key.fromMe = await areJidsSameUser(m.sender, kanna.user.jid)
            ...
            kanna.ev.emit("messages.upsert", msg)
        }
        ...
        if (isGroup && isBotAdmin && isAntilink && !isAdmin && !isOwner) {
            if (budy.match("://chat.whatsapp.com/")) {
                setTimeout( () => {
                    kanna.groupParticipantsUpdate(from, [sender], "remove")
                }, 5 * 1000)
                setTimeout( () => {
                    m.reply('*⭔ Link In This Group Detected!*\n_Sorry you will be kicked from this group!_')
                }, 0)
            }
        }
        ...
        if (isAntidelete && m.message && m.message.protocolMessage && m.message.protocolMessage.type == 0) {
            ...
            let msg = await kanna.serializeM(await Store.loadMessage(key.remoteJid, key.id))
            let teks = `「 Message Delete Detected 」\n\n⬡ Name : ${msg.pushName}\n⬡ User : @${msg.sender.split("@")[0]}\n⬡ Date : ${moment(msg.messageTimestamp * 1000).tz(config.timezone)}\n⬡ Type : ${msg.type}\n`
            let tekss = teks.replace("GMT+0530", "")
            kanna.relayMessage(m.from, msg.message, { messageId: msg.id })
            await kanna.sendText(m.from, tekss, msg, { mentions: [msg.sender] })
        }
        ...
        try {
            if (asahotak.hasOwnProperty(m.sender.split('@')[0]) && !isCmd) {
                ...
                if (budy.toLowerCase() == jawaban) {
                    await kanna.sendMessage(m.from, { text:`Congratulations ${budy} Answer Correct 🎉\n\nWant to play again? Press the Next button below \n`, footer:'Entertainment\nPowered By nexusNw', buttons:[{ buttonId:'asahotak', buttonText:{ displayText:'Carry on'}, type:1 }], headerType:4 }, { quoted: m })
            ...
            if (caklontong.hasOwnProperty(m.sender.split('@')[0]) && !isCmd) {
                ...
                if (budy.toLowerCase() == jawaban) {
                    await kanna.sendMessage(m.from, { text:`Selamat Jawaban ${budy} Benar 🎉\n\nIngin bermain lagi? Tekan Tombol carry on dibawah\n`, footer:'Entertainment\nPowered By nexusNw', buttons:[{ buttonId:'caklontong', buttonText:{ displayText:'carry on'}, type:1 }], headerType:4 }, { quoted: m })
            ...
            if (family100.hasOwnProperty(m.sender.split('@')[0]) && !isCmd) {
                ...
                if (budy.toLowerCase() == result) {
                    await kanna.sendMessage(m.from, { text:`One of the answers is correct,  ${budy} .Congratulations 🎉\n\nWant to play again? Press the Next button below\n`, footer:'Entertainment\nPowered By nexusNw', buttons:[{ buttonId:'family100', buttonText:{ displayText:'carry on'}, type:1 }], headerType:4 }, { quoted: m })
            ...
            if (siapakah.hasOwnProperty(m.sender.split('@')[0]) && !isCmd) {
                ...
                if (budy.toLowerCase() == jawaban) {
                    await kanna.sendMessage(m.from, { text:`Selamat Jawaban ${budy} Benar 🎉\n\nIngin bermain lagi? Tekan Tombol carry on dibawah\n`, footer:'Entertainment\nPowered By nexusNw', buttons:[{ buttonId:'siapakah', buttonText:{ displayText:'carry on'}, type:1 }], headerType:4 }, { quoted: m })
            ...
            if (susunkata.hasOwnProperty(m.sender.split('@')[0]) && !isCmd) {
                ...
                if (budy.toLowerCase() == jawaban) {
                    await kanna.sendMessage(m.from, { text:`Selamat Jawaban ${budy} Benar 🎉\n\nIngin bermain lagi? Tekan Tombol carry on dibawah\n`, footer:'Entertainment\nPowered By nexusNw', buttons:[{ buttonId:'susunkata', buttonText:{ displayText:'carry on'}, type:1 }], headerType:4 }, { quoted: m })
            ...
            if (tebakbendera.hasOwnProperty(m.sender.split('@')[0]) && !isCmd) {
                ...
                if (budy.toLowerCase() == jawaban) {
                    await kanna.sendMessage(m.from, { text:`Selamat Jawaban ${budy} Benar 🎉\n\nIngin bermain lagi? Tekan Tombol carry on dibawah\n`, footer:'Entertainment\nPowered By nexusNw', buttons:[{ buttonId:'tebakbendera', buttonText:{ displayText:'carry on'}, type:1 }], headerType:4 }, { quoted: m })
            ...
            if (tebakgambar.hasOwnProperty(m.sender.split('@')[0]) && !isCmd) {
                ...
                if (budy.toLowerCase() == jawaban) {
                    await kanna.sendMessage(m.from, { text:`Selamat Jawaban ${budy} Benar 🎉\n\nIngin bermain lagi? Tekan Tombol carry on dibawah\n`, footer:'Entertainment\nPowered By nexusNw', buttons:[{ buttonId:'tebakgambar', buttonText:{ displayText:'carry on'}, type:1 }], headerType:4 }, { quoted: m })
            ...
            if (tebakkabupaten.hasOwnProperty(m.sender.split('@')[0]) && !isCmd) {
                ...
                if (budy.toLowerCase() == jawaban) {
                    await kanna.sendMessage(m.from, { text:`Selamat Jawaban ${budy} Benar 🎉\n\nIngin bermain lagi? Tekan Tombol carry on dibawah\n`, footer:'Entertainment\nPowered By nexusNw', buttons:[{ buttonId:'tebakkabupaten', buttonText:{ displayText:'carry on'}, type:1 }], headerType:4 }, { quoted: m })
            ...
            if (tebakkalimat.hasOwnProperty(m.sender.split('@')[0]) && !isCmd) {
                ...
                if (budy.toLowerCase() == jawaban) {
                    await kanna.sendMessage(m.from, { text:`Selamat Jawaban ${budy} Benar 🎉\n\nIngin bermain lagi? Tekan Tombol carry on dibawah\n`, footer:'Entertainment\nPowered By nexusNw', buttons:[{ buttonId:'tebakkalimat', buttonText:{ displayText:'carry on'}, type:1 }], headerType:4 }, { quoted: m })
                    delete tebakkalimat[m.sender.split('@')[0]]
                } else m.reply('*Wrong Answer!q*')
            }
            if (tebakkata.hasOwnProperty(m.sender.split('@')[0]) && !isCmd) {
                jawaban = tebakkata[m.sender.split('@')[0]]
                if (budy.toLowerCase() == jawaban) {
                    await kanna.sendMessage(m.from, { text:`Selamat Jawaban ${budy} Benar 🎉\n\nIngin bermain lagi? Tekan Tombol carry on dibawah\n`, footer:'Entertainment\nPowered By nexusNw', buttons:[{ buttonId:'tebakkata', buttonText:{ displayText:'carry on'}, type:1 }], headerType:4 }, { quoted: m })
            ...
            if (tebaklagu.hasOwnProperty(m.sender.split('@')[0]) && !isCmd) {
                ...
                if (budy.toLowerCase() == jawaban) {
                    await kanna.sendMessage(m.from, { text:`Selamat Jawaban ${budy} Benar 🎉\n\nIngin bermain lagi? Tekan Tombol carry on dibawah\n`, footer:'Entertainment\nPowered By nexusNw', buttons:[{ buttonId:'tebaklagu', buttonText:{ displayText:'carry on'}, type:1 }], headerType:4 }, { quoted: m })
            ...
            if (tekateki.hasOwnProperty(m.sender.split('@')[0]) && !isCmd) {
                ...
                if (budy.toLowerCase() == jawaban) {
                    await kanna.sendMessage(m.from, { text:`Selamat Jawaban ${budy} Benar 🎉\n\nIngin bermain lagi? Tekan Tombol carry on dibawah\n`, footer:'Entertainment\nPowered By nexusNw', buttons:[{ buttonId:'tekateki', buttonText:{ displayText:'carry on'}, type:1 }], headerType:4 }, { quoted: m })
            ...
            if (tebaklirik.hasOwnProperty(m.sender.split('@')[0]) && !isCmd) {
                ...
                if (budy.toLowerCase() == jawaban) {
                    await kanna.sendMessage(m.from, { text:`Selamat Jawaban ${budy} Benar 🎉\n\nIngin bermain lagi? Tekan Tombol carry on dibawah\n`, footer:'Entertainment\nPowered By nexusNw', buttons:[{ buttonId:'tebaklirik', buttonText:{ displayText:'carry on'}, type:1 }], headerType:4 }, { quoted: m })
            ...
            if (tebaktebakan.hasOwnProperty(m.sender.split('@')[0]) && !isCmd) {
                ...
                if (budy.toLowerCase() == jawaban) {
                    await kanna.sendMessage(m.from, { text:`Selamat Jawaban ${budy} Benar 🎉\n\nIngin bermain lagi? Tekan Tombol carry on dibawah\n`, footer:'Entertainment\nPowered By nexusNw', buttons:[{ buttonId:'tebaktebakan', buttonText:{ displayText:'carry on'}, type:1 }], headerType:4 }, { quoted: m })
