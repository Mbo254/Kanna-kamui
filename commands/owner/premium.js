...
module.exports = {
    ...
    type: "owner",
	example: "\n\nExample: %prefix%command add @tag/91812xxx 30d\nExample: %prefix%command del @tag/91812xxx",
    start: async (kanna, m, { ar, args, prefix, command }) => {
		if (args.length < 2) return m.reply(`Example: ${prefix + command} add @tag/91812xxx 30d\nExample: ${prefix + command} del @tag/91812xxx`)
        if (ar[0] === 'add') {
