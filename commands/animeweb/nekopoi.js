...
module.exports = {
    ...
    start: async(kanna, m, { text }) => {
        if (text.toLowerCase() === "random") {
            ...
            //kanna.sendFile(m.from, fetch.result.img, "", m, { caption }) yg gambarnya kena internet positif
            ...
            //kanna.sendFile(m.from, fetch.result[0].img, "", m, { caption }) yg gambarnya kena internet positif
            kanna.sendText(m.from, caption, m)
        } else {
