module.exports = {
    ...
    type: "convert",
    example: "\Colong : %prefix%command --sticker reply\nTake : %prefix%command packname|author --sticker reply",
    start: async(kanna, m, { command, prefix, args, quoted, mime }) => {
        ...
        if (/image|video|sticker/.test(mime)) {
            ...
            kanna.sendFile(m.from, download, "", m, { asSticker: true, author: author, packname: packname, categories: ['😄','😊'] })
        } else {
